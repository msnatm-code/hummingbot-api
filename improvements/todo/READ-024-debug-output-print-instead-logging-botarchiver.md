...
- [ ] utils/bot_archiver.py has no `print(` calls
- [ ] Success messages use logger.info and the credentials failure uses logger.error
- [ ] A module-level logger is defined
