...
- [ ] grep -rn "Dict\[str, any\]\|: any\b\|-> any\b" over services/ returns no matches
- [ ] Each touched file imports `Any` from typing
- [ ] A type checker no longer reports 'Function ... not valid as a type' for these lines
