...
- [ ] allow_origins se lee de configuracion y por defecto no es '*' cuando se permiten credenciales
- [ ] Peticiones cross-origin desde un Origin no listado son rechazadas por el navegador
- [ ] La lista de origenes permitidos es configurable por variable de entorno
