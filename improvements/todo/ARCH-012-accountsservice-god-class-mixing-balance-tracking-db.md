...
- [ ] Portfolio distribution math lives in a dedicated module with no DB/gateway/connector imports and has unit tests
- [ ] Gateway wallet CRUD/pricing lives in its own service consumed by AccountsService
- [ ] accounts_service.py is materially smaller and AccountsService no longer imports gateway HTTP clients directly for analytics
- [ ] existing /portfolio and /trading endpoints return identical responses
