...
- [ ] _last_known_prices is initialized per-instance in __init__, not as a class attribute
- [ ] Two AccountsService instances do not share the same price cache
- [ ] Reads/writes at services/accounts_service.py:904 and :923 operate on the instance cache
