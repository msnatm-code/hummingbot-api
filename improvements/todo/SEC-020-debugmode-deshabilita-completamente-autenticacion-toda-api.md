...
- [ ] Con debug_mode activo, el arranque registra una advertencia de seguridad clara
- [ ] debug_mode no puede activarse silenciosamente en el entorno de produccion configurado
- [ ] Los endpoints sensibles siguen exigiendo auth salvo en el modo de desarrollo explicitamente reconocido
