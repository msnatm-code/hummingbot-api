...
- [ ] The inline fallback loop (lines 908-915) is replaced by a call to `_get_fallback_prices`
- [ ] Behavior for cached-present and cached-absent pairs is unchanged
- [ ] Only one implementation of the cached-price fallback remains
