...
commits:
  - "51f4ea4 (perf) PERF-005: demote order-event hot-path logging to debug"
status: done
created: 2026-06-11
---
...
- [x] Order create/fill recording no longer emits INFO logs per event
- [x] Listener-introspection logging in start() runs only when DEBUG is enabled
- [x] Error and warning logging is unchanged
- [x] No change to actual order/trade persistence behavior
