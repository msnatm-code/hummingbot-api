...
commits:
  - "3a92452 (refactor) ARCH-015: shared balance-entry and gateway-guard helpers"
status: done
created: 2026-06-11
---
...
- [x] A single helper produces the balance entry dict, used by both _get_connector_tokens_info and get_gateway_balances
- [x] the four 503 gateway guards call one shared helper/decorator
- [x] balance JSON responses and the 503 behavior are unchanged
...
El ping de gateway solo-logging del loop de balances quedó intacto a propósito (per spec).
